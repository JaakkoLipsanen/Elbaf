...
/* PARAMETER SETTERS */
void OGL::Shader::SetValue(std::string const& valueName, const float& value)
{
	glUniform1f(_pImpl->GetUniformLocation(valueName), value);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector2f& value)
{
	glUniform2f(_pImpl->GetUniformLocation(valueName), value.x, value.y);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector3f& value)
{
	glUniform3f(_pImpl->GetUniformLocation(valueName), value.x, value.y, value.z);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector4f& value)
{
	glUniform4f(_pImpl->GetUniformLocation(valueName), value.x, value.y, value.z, value.w);
}

void OGL::Shader::SetValue(std::string const& valueName, const int& value)
{
	glUniform1i(_pImpl->GetUniformLocation(valueName), value);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector2i& value)
{
	glUniform2i(_pImpl->GetUniformLocation(valueName), value.x, value.y);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector3i& value)
{
	glUniform3i(_pImpl->GetUniformLocation(valueName), value.x, value.y, value.z);
}

void OGL::Shader::SetValue(std::string const& valueName, const Vector4i& value)
{
	glUniform4i(_pImpl->GetUniformLocation(valueName), value.x, value.y, value.z, value.w);
}

void OGL::Shader::SetValue(std::string const& valueName, const Matrix2x2& value) // bool transpose
{
	glUniformMatrix2fv(_pImpl->GetUniformLocation(valueName), 1, GL_FALSE, &value[0][0]);
}

void OGL::Shader::SetValue(std::string const& valueName, const Matrix3x3& value) // bool transpose
{
	glUniformMatrix3fv(_pImpl->GetUniformLocation(valueName), 1, GL_FALSE, &value[0][0]);
}

void OGL::Shader::SetValue(std::string const& valueName, const Matrix4x4& value) // bool transpose
{
